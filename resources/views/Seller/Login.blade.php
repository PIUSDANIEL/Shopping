...
<div class=" row  registerrow bringitdownreglog mx-auto">
    ...
    <div  class="col-sm-6 bg-info registercol mx-auto p-3" >
        <div class="row welcomeregister">
            <h6 class="text-center text-light ">Don't have an Shop</h6>
            <h6 class="text-center text-light "><a href="{{ route('seller.register') }}"><button  class="btn btn-outline-light  rounded-pill">Register Shop</button> </a></h6>
        </div>
    </div>
    ...
    <div class="col-sm-6 shadow registercol mx-auto" >
      ...
      @endif
        ...
        <form action="{{route('seller.sellerLogin')}}" method="POST">
                @csrf
            <div class="mb-2">
