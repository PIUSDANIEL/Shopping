...
<div class=" row  registerrow bringitdownreglog mx-auto">
    ...
    <div class="col-sm-12 shadow  registercol mx-auto" >
        ...
        <div class=" d-flex justify-content-end bg-info rounded p-2">
              <a href="{{ route('seller.login') }}" class="ml-3 text-light">Already have a Shop <p>visit shop</p></a>

        </div>


      <h2 class="mt-4 mb-2">Register as a seller</h2>
      ...
      <form action="{{ route('seller.sellerRegister') }}" method="post" class="row g-3 needs-validation" novalidate>
             ...
             @csrf
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="shopname" value="{{ old('shopname') }}" class="form-control form-control-sm" id="shopname" >
                    <div class="invalid-feedback">
